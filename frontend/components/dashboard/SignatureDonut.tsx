...
export function SignatureDonut({ completed, partial, pending }: SignatureDonutProps) {
  ...
  return (
    <Card className="border border-slate-200 dark:border-slate-700 shadow-sm bg-white dark:bg-slate-900">
      ...
      <CardContent>
        <div role="img" aria-label={`Grafico de estados de firma. ${chartDescription}. Total: ${total}`}>
        ...
        {total > 0 && (
          <div className="text-center -mt-2">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Total documentos</p>
          </div>
        )}
      </CardContent>
    </Card>
